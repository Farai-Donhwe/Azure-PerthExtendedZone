...
| Area | Service | Uptime Percentage | Service Credit |
|:-----|:--------|:-----------------|:---------------|
| **Compute** | VM | < 99.9% | 10% |
| | VMSS | | |
...
{: .note }
> The Service-specific SLAs above might differ from the SLAs on the Microsoft SLA page.
