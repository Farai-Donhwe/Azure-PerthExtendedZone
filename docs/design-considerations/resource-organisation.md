...
{: .important }
> Access to Azure Extended Zones is regulated through a controlled access process. You must register the subscription(s) intended for Extended Zone deployments. See the [Onboarding]({% link docs/overview/pricing.md %}) section.
