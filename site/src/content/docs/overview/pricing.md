...
- Data Centre Data Transfer pricing for Perth Extended Zones (excluding transfers covered under CDN and ExpressRoute pricing) is categorised as **Inter-Region**.
...
Access to Azure Extended Zones will be restricted and managed through a **controlled access process** involving three primary steps.

Comprehensive guidelines on how to request access can be found in the [Request access to an Azure Extended Zone](https://learn.microsoft.com/en-us/azure/extended-zones/request-access) article.
