---
title: Overview
description: Introduction to Azure Extended Zones — small-footprint extensions of Azure for latency-sensitive and data-residency workloads.
sidebar:
  order: 0
---
...
| Question | Guidance |
|:---------|:---------|
| **What are your timelines?** | Services within Azure Extended Zones will become available in phases. Ensure your deadline aligns with the launch schedules and incorporates a buffer for contingencies. See [Service Availability](./service-availability/). |
| **What services will you use?** | Assess whether your solution requires specific services that may not yet be available. Third-party Marketplace services also need ISV validation. See [Service Availability](./service-availability/) and [ISV Solutions](./isv-solutions/). |
...
| **HA & DR requirements?** | Azure Extended Zones do not support availability zones but support additional services for availability and disaster recovery. See [BCDR](../design-considerations/bcdr/). |
