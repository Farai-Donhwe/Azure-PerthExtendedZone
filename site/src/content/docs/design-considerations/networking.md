...
:::tip[Roadmap]
The deployment of Azure Virtual WAN Hub within Azure Extended Zones is **currently unsupported**. See [Service Availability](../overview/service-availability/) for updates.
:::
